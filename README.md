...
<p align="center">
  <a href="https://www.chillssl.com/">
    <img src="./docs/images/chillssl-dashboard-music-dark.png" alt="Chill SSL dark dashboard SSL monitor with certificate health scores, SSL reminders, and status overview" width="920" />
  </a>
</p>

<p align="center">
  <a href="https://www.chillssl.com/">
    <img src="./docs/images/chillssl-dashboard-music-light.png" alt="Chill SSL light dashboard SSL monitor with certificate health scores, SSL reminders, and status overview" width="920" />
  </a>
</p>

<p align="center"><em>Chill SSL: SSL monitor, SSL reminders, and SSL notifications (dark and light)</em></p>
...
Chill SSL is built for modern certificate lifecycles, including short-lived certificates, where classic SSL reminder tools often stop too early. Use it as your SSL tool and SSL monitor when renewals are automated and you still need proof that certificates are healthy.
...
Describe the problem you’re trying to solve with Chill SSL (SSL monitoring, SSL reminders, SSL notifications, reporting, etc.). Proposed solutions are welcome but optional.
...
Chill SSL is a commercial SSL monitoring product and SSL tool. This repository does **not** contain application source code. It exists so customers can follow releases, report bugs, and suggest improvements.
